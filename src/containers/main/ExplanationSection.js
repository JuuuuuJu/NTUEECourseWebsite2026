...
- 電磁波實驗開設兩個時段，**請擇一挑選到志願序內**，若兩個時段都排志願序不會增加選上的機率，反而會占用其他實驗的排序。
- 可設置0~10個志願序 (不含數電實驗、有兩個電磁波實驗)，所有志願序都有可能選上。
數電實驗請在十選二頁面以3人小組報名。組滿後才會登記獨立抽籤。
- 所有學生至多選上2門實驗，包含數電實驗。
- 抽籤作業流程：(A)數電實驗抽籤 → (B)志願序抽籤

十選二實驗規定：[https://reurl.cc/xpvQ04](https://reurl.cc/xpvQ04)`

const message4 = `數電實驗以完整三人小組為單位抽籤，共12組。小組年級以三位成員中的最低年級計算；高年級組別優先，同年級組別隨機排序。`;
